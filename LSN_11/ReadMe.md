...
The requirements for the exercise are outlined in the notebook `LSN_Exercises_11.ipynb`. They are divided into three parts:
...
- **Exercise 11.3: 2D Trigonometric Fit**
...
The implementation and analysis are contained in `LSN_Notebook_11.ipynb`. The notebook utilizes a custom Python module, `ml_functions.py` (located in the parent directory), which wraps Keras functionalities to streamline dataset generation, model creation, training, and visualization.
...
| `LSN_Notebook_11.ipynb` | **Jupyter Notebook** containing the implementation and analysis. |
...
└── LSN_11/
    ...
    ├── LSN_Notebook_11.ipynb   # Jupyter Notebook for data analysis.   
    ├── ReadMe.md
    └── images/
```