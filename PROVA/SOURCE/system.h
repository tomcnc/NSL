...
private:
  ...
  string _dist_type;          // Type of starting velocity distribution (Dirac or Maxwell-Boltzmann) added by me
  ...
  bool _measure_temp_step, _measure_tenergy_temp, _measure_magnet_temp; // Flag for measuring temperature at each step of simulation
