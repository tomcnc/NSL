...
private:
  ...
  bool _measure_magnet_step;                                                // Flag for measuring magnetization at each step
  bool _measure_pofv;                                                       // Flag for measuring the velocity modulus distribution
  bool _tails;                                                              // Flag for using potential and pressure tail corrections 
  ...
  int _index_H2;                                                            // Index for accessing hamiltonian squared to compute specific heat
  ...
  double _pofv_normalization, _pofv_increment;                              // Normalization and increment constant for velocity modulus distribution
  vec _gofr_normalization, _gofr_increment;                                 // Normalization and increment vector for radial distribution function (vec since each bin has its normalization constant)
